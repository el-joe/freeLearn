<footer class="mt-32" style="background-color: rgba(37, 38, 65, 1)">
    <div class="max-w-lg mx-auto">
        <div class="flex py-12 justify-center text-white items-center px-20 sm:px-36">
            <div class="relative">
                <h1 class="font-bold text-xl pr-5 relative z-50">Free Learn Eg</h1>
                ...
                <h1 class="font-bold text-sm text-sm pt-5  relative z-50">ملك شركه النهائي للتعليم عن بعد</h1>
            </div>
        </div>
    </div>
</footer>
