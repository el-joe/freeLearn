        ...
        <tbody>
          @foreach ($academicYears as $year)
            <tr>
                ...
                <td>{{$year->name}}</td>
                <td>
                    <a href="{{route('admin.academic-years.edit', $year->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                    <a href="{{route('admin.academic-years.destroy', $year->id)}}" class="btn btn-danger btn-xs deleteThis"><i class="fa fa-trash-o "></i></a>
                </td>
          @endforeach
        </tbody>
      </table>
